                  ...
                  <Col md={12}>
                    <form>
                      <Card
                        ...
                        content={
                          <div>
                            <FormGroup>
                              ...
                              <FormControl type="text" name="title" onChange={ (event) => this.handleEmailChange(event) }/>
                              {this.state.emailError}
                            </FormGroup>
                            <FormGroup>
                              <ControlLabel>Subject Line: <span className="star">*</span></ControlLabel>
                              <FormControl type="text" name="subject" onChange={ (event) => this.handleEmailChange(event) }/>
                              {this.state.emailError}
                            </FormGroup>
                            <FormGroup>
                        ...
                        legend={
                          <div>
                            <Checkbox number={1} label="Don't be a jerk"/>
                          </div>
                        }
                      />
                    </form>

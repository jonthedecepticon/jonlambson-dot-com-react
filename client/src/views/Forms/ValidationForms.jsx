                      ...
                      <Card
                        ...
                        content={
                          <div>
                            ...
                            <FormGroup>
                              <ControlLabel>Subject Line: <span className="star">*</span></ControlLabel>
                              <FormControl type="text" name="subject" />
                            </FormGroup>
                            <FormGroup>
                              <ControlLabel>Email address list: <span className="star">*</span></ControlLabel>
                              <FormControl type="text" name="email" />
                            </FormGroup>
                            <FormGroup >
                              <ControlLabel>Body: <span className="star">*</span></ControlLabel>
                              <FormControl componentClass="textarea" type="text" name="body"/>
                            </FormGroup>
                        ...
                        legend={
                          <div>
                            <Checkbox number={1} label="I agree not to spam people."/>
                          </div>
                        }
                      />
                    </form>
